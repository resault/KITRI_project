...
<section style="padding-top: 0px; padding-bottom: 10px;">
   ...
   <img src="${root}/resources/images/admin/geomsa_content.JPG" style="width: 1000px !important; margin-left: 200px;  margin-top: 20px;">
</section>
