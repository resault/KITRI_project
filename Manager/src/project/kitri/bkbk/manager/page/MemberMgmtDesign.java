package project.kitri.bkbk.manager.page;
...
import project.kitri.bkbk.manager.popup.MemDialog;
	...
	public MemberMgmtDesign() {
		...
		findB = new JButton() {
			...
			protected void paintComponent(Graphics g) {
				Dimension d = getSize();
				ImageIcon imageIcon = new ImageIcon(".\\src\\project\\kitri\\bkbk\\image\\magnifying-glass.png");
