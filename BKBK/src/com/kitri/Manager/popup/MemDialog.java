...
public class MemDialog extends JDialog {
	...
	private final JLabel label_3 = new JLabel("월");
	public  JTextField birth3 = new JTextField();
	private final JLabel label_4 = new JLabel("일");
	...
	public MemDialog() {
		...
		infoBirth.setFont(new Font("맑은 고딕", Font.PLAIN, 12));
		infoBirth.setBounds(91, 261, 241, 20);
		
		contentPanel.add(infoBirth);
		infoPhoneNum.setForeground(Color.RED);
		infoPhoneNum.setFont(new Font("맑은 고딕", Font.PLAIN, 12));
